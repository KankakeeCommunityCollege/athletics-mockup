    ...
    $.getJSON(url, function(data) {  // make JSON call to Google Data API
      ...
      entry.forEach(function(entry) { // Run a 'forEach()' loop on the entrys:
        ...
        function buildTableRows() {
          ...
          html += '<td align="center" class="mx-auto" style="vertical-align:top;background-color:' + color + ';color:#ffffff;">' + entry['gsx$start']['$t'] + endDate + '</td>'; // Date Column: gets the appropriate background color and an end-date added if it exists.
