document.addEventListener('DOMContentLoaded', function() {
  ...
  function checkPageLocation() {
    if ( noProto.indexOf('mens-basketball/roster') > -1 ) {  // If user's current URL contains '/schedule' in it, do:
      mBasketballRoster();  // Go-go gadget spreadsheetTable()!
    } else if ( noProto.indexOf('womens-basketball/roster') > -1 ) {
      wBasketballRoster();
    }
  }
